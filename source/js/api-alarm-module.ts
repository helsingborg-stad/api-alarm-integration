...
const ApiAlarmIntegration: ApiAlarmIntegrationType = {};
...
class AlarmModule {
	...
	getFilters() {
		const filters: { [key: string]: any } = {
			...
			date_from: this.getInputValue(
				this.AlarmList.querySelector('#data-alarm-filter-date-from')?.querySelector('input'),
			),
	...
	addAlarmToList(item) {
		...
		// Append alarm
		const alarm = ApiAlarmIntegration.Helper.Template.render('api-alarm-integration-row', item);
